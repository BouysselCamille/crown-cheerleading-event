const en = {
  ...
  schedule: {
    ...
    items: [
      ...
      { time: '11h00', label: 'Block 1 - Novice, Prep & University' },
      { time: '13h30', label: 'Block 1 Awards Ceremony' },
      { time: '14h30', label: 'Block 2 — AllStar' },
      { time: '17h00', label: 'Block 2 Awards Ceremony' },
  ...
  divisions: {
    ...
    noteDemo: '<span class="text-white font-semibold">Exhibition team:</span> Registration fee is <span class="text-gold font-semibold">75% of the current rate</span>.',
    ...
    pricing: [
      {
        ...
        badge: 'Best rate',
        rows: [
          { cat: 'Allstar / University / Prep', price: '50.00 EUR' },
      ...
      },
      {
        ...
        badge: null,
        rows: [
          { cat: 'Allstar / University / Prep', price: '55.00 EUR' },
  ...
  recompenses: {
    ...
    prizeLabel: 'Prize',
    note: '* Teams with age exceptions will not be eligible. The two prizes will be awarded to different clubs. Judges will be consulted if scores are tied or point to the same club twice.',
    rewards: [
    ...
    grandChamps: [
      ...
      },
      {
        ...
        desc: 'The team with the highest score across University and Prep categories',
        prize: '1,000 EUR',
      },
    ],
  },
  ...
  tickets: {
    ...
    soon: 'Ticketing will open on September 10, 2026',
  },
  ...
  contact: {
    ...
    fields: {
      ...
      subjects: [
        { value: 'inscription', label: 'Team registration' },
        { value: 'billetterie', label: 'Ticketing' },
        { value: 'partenariat', label: 'Partnership / Sponsorship' },
  ...
  footer: {
    ...
    contact: 'Contact',
    contactText: 'For any questions, use\nthe contact form.',
