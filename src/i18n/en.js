...
badge: 'Judged under IASF / United Scoring System standards',
  ...
  schedule: {
    ...
    items: [
      ...
      { time: '9h30', label: 'Bloc 1 - Prep, University & some level 1 divisions' },
      { time: '12h15', label: 'Bloc 1 Awards Ceremony' },
      { time: '12h45', label: 'Bloc 2 - AllStar' },
      { time: '15h20', label: 'Bloc 2 Awards Ceremony' },
      { time: '16h00', label: 'End of event' },
    ],
  },
  ...
  inscription: {
    ...
    formDesc: 'Team registration will take place on the <strong>Cheer Genius</strong> platform starting <strong>September 10</strong>.',
    prepareLabel: 'Opens September 10',
    downloadBtn: 'Register on Cheer Genius',
  },
